...
def create_video_user_images(
    ...
    """Creates a video when the user provides custom images"""
...
def create_video_no_images(
    video_name, images_dir, tmp_dir, use_audio, audiopath, textpath, usage_rights
):
    """Create a video when the user doesn't provide images"""
    try:
        creator = VideoCreator(
            images_dir=images_dir,
            tmp_dir=tmp_dir,
