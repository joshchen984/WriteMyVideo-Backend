...
class ImageCreator:
    ...
    def write_frames(self, words, prev_words, tmp_dir):
        idx = 0
        prev_timestamp = 0
        timestamp = 0
...
class VideoCreator:
    ...
    def create_video(self):
        ...
        print("Collected image words:", image_words)
        print(prev_words)
        ...
        self.img_creator.write_frames(words, prev_words, self.tmp_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-a","--audiopath",type = str,help = "file path for the audio file to use. If ommited the program will use google text to speech to create the audio")
    ...
    if args.audiopath:
        ...
        use_audio = False
    creator = VideoCreator(images_dir, tmp_dir, use_audio, args.audiopath, textpath,os.path.join(tmp_dir, 'full_video.mp4'))
